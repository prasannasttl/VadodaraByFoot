...
[assembly: Xamarin.Forms.Dependency(typeof(VadodaraByFoot.Droid.DependencyService.SimpleAudioPlayerImplementation))]
        ...
        { get
            {
                ...
                {
                    if (((((double)player.Duration) / 1000.0) <= 3600) && ((player.Duration /1000.0)> 0))
                    {
